...
const resultsUrl = "./friends_list.html";
...
/*     event.preventDefault(); */
    ...
    if (userInput) {
        ...
        alert("Please enter your friends book list");
    }
};
...
function pageRedirect() {
    redirectEl.setAttribute('href', './friends_list.html');
...
function pageRedirectNav() {
    redirectNavEl.setAttribute('href', './friends_list.html');
